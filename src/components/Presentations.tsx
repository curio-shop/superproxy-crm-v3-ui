...
export default function Presentations({ showRecordModal, onCloseRecordModal, onOpenRecordModal, onDeletePresentation, onUpgrade }: PresentationsProps) {
  ...
  return (
    <div className="flex-1 overflow-y-auto custom-scrollbar p-6 space-y-6">
      ...
      {showRecordModal && <RecordPresentationModal onClose={onCloseRecordModal} onUpgrade={onUpgrade} />}
    </div>
  );
}
